...
import InputItem from "../components/Lists/InputItem";
...
const ListPage = () => {
  ...
  const listData=useQuery(QUERY_LISTS)
  console.log (listData);
  const { loading: meLoading, data: meData, error: meError } = useQuery(QUERY_ME)
  console.log("hey", meData)
  ...
  return (
    <div>
      {lists && !lists.length &&
        <h1>
          Navigate to dashboard to add a list
        </h1>
      }
        ...
        return (
          <div className="card">
            <div className="card-body">
              <h1 className="card-title">{list.listName}</h1>
              <h6 className="card-text">{list.description}</h6>
              <Dropdown>
                <Dropdown.Toggle variant="success" id="dropdown-basic">
                  List Theme
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item value="birthday-theme">Birthday 🎉
                  </Dropdown.Item>
                  <Dropdown.Item value="christmas-theme"
                  >
                    Christmas 🎄
                  </Dropdown.Item>
                  <Dropdown.Item value="halloween-theme"
                  >
                    Halloween 🎃
                  </Dropdown.Item>
                </Dropdown.Menu>
